...
pub fn robot_status(entries: &Entries, robot_id: &str) -> proto::RobotStatus {
    ...
    proto::RobotStatus {
        ...
        operational_mode: get_string(entries, &k("operational_mode")),
        motion_paused: get_bool(entries, &k("motion_paused")),
        robot_model: get_string(entries, &k("robot_model")),
        serial_number: get_string(entries, &k("serial_number")),
        polyscope_version: get_string(entries, &k("polyscope_version")),
...
mod tests {
    ...
    fn robot_suffixes_cover_every_key_robot_status_reads() {
        ...
        for (suffix, value) in [
            ...
            ("motion_paused", GuiValue::Bool(BoolOrUnknown::Bool(true))),
